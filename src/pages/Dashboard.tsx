              ...
              <form id="manage-form" onSubmit={handleUpdateUser} className="space-y-5">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-blue-900 uppercase tracking-wide">Work Hours</span>
                  ...
                  <div className="relative">
                    <PlusCircle className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-500 w-5 h-5" />
                    <input
                      type="number"
                      min="0"
                      step="0.5"
                      ...
                      placeholder="Add hours (e.g. 8.5)"
                      className="w-full bg-white border border-blue-200 rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-900"
                    />
                  </div>
                  <p className="text-xs text-gray-500">Hours will be added to current total</p>
                </div>
              </form>
            </div>
